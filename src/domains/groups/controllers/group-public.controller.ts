...
export class GroupPublicController {
	...
	@ApiOperation(GroupPublicDocs.findGroupResponsibilities)
	async findGroupResponsibilities(@Param('id') id: string) {
		return await this.service.findGroupResponsibilities(id);
	}
}
