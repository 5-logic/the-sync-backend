...
export const SemesterDocs = {
	...
	getAIStatistics: {
		summary: 'Get AI API call statistics by semester',
		description: `Returns statistics of AI API calls made during a specific semester.\n\n- **For ADMIN or MODERATOR only** (authentication and authorization required).\n- Aggregates data based on the provided semesterId.\n- Returns the following information:\n  + **semesterId**: The semester ID.\n  + **totalCalls**: Total number of AI API calls made in the semester.\n  + **statistics**: Array of AI API call counts grouped by type (CheckDuplicateThesis, SuggestThesis, SuggestParticipants).\n- Returns 404 error if semester not found.\n- Logs all AI statistics accesses and errors.`,
	} as ApiOperationOptions,
